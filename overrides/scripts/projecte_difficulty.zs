...
recipes.addShaped(<projecte:item.pe_philosophers_stone>,
  [[darkmatterBlock,<xreliquary:mob_charm>.withTag({type: 9 as byte}).giveBack(<xreliquary:mob_charm>.withTag({type: 9 as byte})), darkmatterBlock],
    [<xreliquary:salamander_eye>.giveBack(<xreliquary:salamander_eye>), <projecte:item.pe_gem_density>.giveBack(<projecte:item.pe_gem_density>), <xreliquary:mob_charm>.withTag({type: 13 as byte}).giveBack(<xreliquary:mob_charm>.withTag({type: 13 as byte}))],
    [darkmatterBlock, <xreliquary:harvest_rod>.giveBack(<xreliquary:harvest_rod>), darkmatterBlock]]);
